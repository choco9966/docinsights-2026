...
| `v2` | 제출 전 | Validation | haetae | A. Hyeonwoo Kim, B. Gwanghwan Lee | `artifacts/submissions/v2.jsonl` | `2be417abe62c528c10bb35e06dfd10e585e7e606804756abf343693b313bef35` | 217 | 제출 전 | 제출 전 | 제출 전 | 제출 전 | v1 의미 변형 오답 후보 6건 수정 |
...
포털은 오답 개수만 제공하고 해당 instance ID는 공개하지 않으므로 아래 6건은 PDF의 정답 evidence, 동일 수치로 생성된 인접 문제와 공개 학습 데이터의 답변 분포를 대조해 추론한 후보입니다. `v2`의 포털 결과가 `1.0`이면 6건이 모두 확인되며, 그렇지 않으면 `v1`과 `v2`를 보존한 채 남은 차이를 다시 검수합니다.
